...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarConsultarPaisRepresentado();
	...
	/**
	 * Este metodo le pide al usuario que ingrese el nombre de un atleta
	 * y le informa al usuario que país representa el atleta consultado
	 */
	private void ejecutarConsultarPaisRepresentado() {
		System.out.println("\n"+"País que represente un atleta"+"\n");
		
		String nombre_atleta = input("Ingrese el atleta que desea consultar: ");
		String p = calculadora.paisRepresentadoPorAtleta(nombre_atleta);
		System.out.println("el atleta representa al país " + p);
	}
